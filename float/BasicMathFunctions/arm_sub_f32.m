function arm_sub_f32()
clc;
fprintf('=== Testing arm_sub_f32 ===\n\n');
errors = 0;

% Test 1: basic vector
x = single([0, 1.5, -2.5, 100, -100, 0.1, -0.1]);
y = single([0, 3.5, 1.5, -50, 50, 0.2, 0.2]);
z = arm_sub_f32_mex(x, y);
fprintf('Test 1 - Basic vector:\n  x: ['); fprintf('%g ', x); fprintf(']\n  y: ['); fprintf('%g ', y); fprintf(']\n  z: ['); fprintf('%g ', z); fprintf(']\n');
ref = single([0, -2, -4, 150, -150, -0.1, -0.3]);
...
tic; z = arm_sub_f32_mex(x, y); t = toc;
