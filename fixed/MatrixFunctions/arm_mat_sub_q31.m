...
clc;
fprintf('=== Testing arm_mat_sub_q31 ===\n\n');
errors = 0;

A = int32([100 200; 300 400]);
B = int32([10 20; 30 40]);
C = arm_mat_sub_q31_mex(A, B);
...
A = int32([2147483647 -2147483648; 0 1]);
B = int32([-2147483648 2147483647; 0 -2]);
C = arm_mat_sub_q31_mex(A, B);
...
rng(42);
A = int32(randi([-2147483648, 2147483647], 4, 4, 'int32'));
B = int32(randi([-2147483648, 2147483647], 4, 4, 'int32'));
tic; C = arm_mat_sub_q31_mex(A, B); t = toc;
fprintf('Test 3 - Random 4x4: %.3f ms\n', t*1000);
s = int64(A) - int64(B);
