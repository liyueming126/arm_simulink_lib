...
y = int32([1, 2147483647, -1, -2147483648]);
z = arm_add_q31_mex(x, y);
fprintf('Test 2 - Saturation:\n  x: ['); fprintf('%d ', x); fprintf(']\n  y: ['); fprintf('%d ', y); fprintf(']\n  z: ['); fprintf('%d ', z); fprintf(']\n');
ref = int32([2147483647, 2147483647, -2147483648, -2147483648]);
if isequal(z, ref)
    fprintf('  PASS\n\n');
else
    fprintf('  FAIL\n\n');
...
tic; z = arm_add_q31_mex(x, y); t = toc;
