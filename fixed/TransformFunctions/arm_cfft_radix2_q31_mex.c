#include "mex.h"
#include <stdint.h>
#include "arm_cfft_radix2_q31_simulink.c"
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs < 3) mexErrMsgTxt("Usage: y = arm_cfft_radix2_q31_mex(data, ifftFlag, bitReverseFlag)");
    ...
    arm_cfft_radix2_q31(&S, (q31_t *)mxGetData(plhs[0]));
}