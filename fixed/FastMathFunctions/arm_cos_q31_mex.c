...
static int32_t arm_cos_q31(int32_t x)
{
    int32_t cosVal;
    int32_t index;
    int32_t a, b;
    ...
    cosVal = (int64_t)(0x80000000LL - fract) * a >> 32;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 1) {
        mexErrMsgIdAndTxt("arm_cos_q31:input", "One input required.");
    }
    if (!mxIsInt32(prhs[0]) || mxGetNumberOfElements(prhs[0]) != 1) {
        mexErrMsgIdAndTxt("arm_cos_q31:input", "Input must be a scalar int32.");
    }
