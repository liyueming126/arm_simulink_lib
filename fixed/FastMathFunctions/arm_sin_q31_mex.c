...
static const int32_t sinTable_q31[FAST_MATH_TABLE_SIZE + 1] = {
...
static int32_t arm_sin_q31(int32_t x)
{
    int32_t sinVal;
    int32_t index;
    int32_t a, b;
    ...
    sinVal = (int64_t)(0x80000000LL - fract) * a >> 32;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 1) {
        mexErrMsgIdAndTxt("arm_sin_q31:input", "One input required.");
    }
    if (!mxIsInt32(prhs[0]) || mxGetNumberOfElements(prhs[0]) != 1) {
        mexErrMsgIdAndTxt("arm_sin_q31:input", "Input must be a scalar int32.");
    }

    x = (int32_t)(*(int32_t *)mxGetData(prhs[0]));
    y = arm_sin_q31(x);

    plhs[0] = mxCreateNumericMatrix(1, 1, mxINT32_CLASS, mxREAL);
    *(int32_t *)mxGetData(plhs[0]) = y;
}