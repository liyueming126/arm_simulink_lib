...
static int16_t arm_cos_q15(int16_t x)
{
    int16_t cosVal;
    int32_t index;
    int16_t a, b;
    ...
    cosVal = (int32_t)(0x8000L - fract) * a >> 16;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 1) {
        mexErrMsgIdAndTxt("arm_cos_q15:input", "One input required.");
    }
    if (!mxIsInt16(prhs[0]) || mxGetNumberOfElements(prhs[0]) != 1) {
        mexErrMsgIdAndTxt("arm_cos_q15:input", "Input must be a scalar int16.");
    }
