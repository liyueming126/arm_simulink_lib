...
static arm_status arm_conv_partial_fast_opt_q15(
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 4)
        mexErrMsgIdAndTxt("arm_conv_partial_fast_opt_q15_mex:invalidInput",
    ...
    status = arm_conv_partial_fast_opt_q15(pSrcA, srcALen, pSrcB, srcBLen, pDst, firstIndex, numPoints, pScratch1, pScratch2);

    if (status != 0)
        mexErrMsgIdAndTxt("arm_conv_partial_fast_opt_q15_mex:rangeError",
