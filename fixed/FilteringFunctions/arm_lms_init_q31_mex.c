...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs < 1)
        mexErrMsgIdAndTxt("arm_lms_init_q31_mex:invalidInput",
            "Inputs: numTaps, [mu=int32(0x40000000)], [blockSize=1], [postShift=0]");
    ...
    else mexErrMsgIdAndTxt("arm_lms_init_q31_mex:invalidType","numTaps must be double or int32");
