...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs < 1)
        mexErrMsgIdAndTxt("arm_lms_norm_init_q15_mex:invalidInput","Input: numTaps, [mu=512], [blockSize=1], [postShift=0]");
    ...
    else mexErrMsgIdAndTxt("arm_lms_norm_init_q15_mex:invalidType","numTaps must be double or int32");
